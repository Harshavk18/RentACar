...
public class Main8Activity extends AppCompatActivity implements View.OnClickListener,SmsListener {
    Button proceed;
    ...
    public void onClick(View v) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            PendingIntent pendingIntent = PendingIntent.getActivity(Main8Activity.this, 1,
                    intent1, PendingIntent.FLAG_UPDATE_CURRENT);

            myNotification  = new Notification.Builder(Main8Activity.this,channel_Id)
            ...
            Notification.Builder builder = new Notification.Builder(Main8Activity.this);
    ...
    private static Main8Activity instance;
    @Override
    ...
    public static Main8Activity getInstance(){
        return instance;
    }
    @Override
    ...
    public void messageReceived(String messageText) {
        ...
        Toast.makeText(Main8Activity.this,"OTP: "+ otp ,
