...
public class Main10Activity extends AppCompatActivity implements View.OnClickListener,SmsListener {
    Button proceed;
    ...
    public void onClick(View v) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            PendingIntent pendingIntent = PendingIntent.getActivity(Main10Activity.this, 1,
                    intent1, PendingIntent.FLAG_UPDATE_CURRENT);

            myNotification  = new Notification.Builder(Main10Activity.this,channel_Id)
            ...
            Notification.Builder builder = new Notification.Builder(Main10Activity.this);
    ...
    private static Main10Activity instance;
    @Override
    ...
    public static Main10Activity getInstance(){
        return instance;
    }
    @Override
    ...
    public void messageReceived(String messageText) {
        ...
        Toast.makeText(Main10Activity.this,"OTP: "+ otp ,
